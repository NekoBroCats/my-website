...
export const skillCategories: SkillCategory[] = [
  {
    ...
    skills: [
      ...
      { name: "展示でどう触られるか考える", level: "can-prototype", relatedWorkIds: ["voxel-row-yonmoku"] },
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "グラフィックを組む", level: "can-prototype", relatedWorkIds: ["moodorgan", "illusion-cards"] },
      { name: "ポスターに落とす", level: "can-prototype", relatedWorkIds: ["moodorgan"] },
      { name: "置き方まで考える", level: "can-prototype", relatedWorkIds: ["voxel-row-yonmoku"] },
      { name: "読む順番を整理する", level: "can-prototype", relatedWorkIds: ["moodorgan", "vr-spatial-ui"] },
    ],
  },
  {
    id: "technical",
  ...
  },
  {
    ...
    skills: [
      ...
      { name: "キャプションを書く", level: "can-prototype", relatedWorkIds: ["moodorgan"] },
